          ...
          <div class="md-layout md-gutter">
            <div class="md-layout-item md-small-size-100">
              <md-field :class="getValidationClass('userName')">
                ...
                <md-input name="userName" id="UserName" autocomplete="given-name" v-model="formUser.userName"
                  :disabled="sending" />
                <span class="md-error" v-if="!$v.formUser.userName.required">The name is required</span>
                <span class="md-error" v-else-if="!$v.formUser.userName.minlength">Invalid User name</span>
              </md-field>
              <md-field :class="getValidationClass('password')">
                <md-icon>password</md-icon>
                <label for="password">password</label>
                <md-input name="password" id="password" autocomplete="given-name" v-model="formUser.password"
                  type="password" :disabled="sending" />
                <span class="md-error" v-if="!$v.formUser.password.required">The password is required</span>
                <span class="md-error" v-else-if="!$v.formUser.password.minlength">Invalid password
                </span>
              </md-field>
              ...
              <md-field :class="getValidationClass('email')">
                ...
                <md-input name="email" id="email" autocomplete="given-name" v-model="formUser.email"
                  :disabled="sending" />
                <span class="md-error" v-if="!$v.formUser.email.required">The email is required</span>
                <span class="md-error" v-else-if="!$v.formUser.email.email">Invalid Email</span>
              </md-field>
              ...
              <md-field :class="getValidationClass('telephone')">
                ...
                <md-input name="telephone" id="telephone" autocomplete="given-name" v-model="formUser.telephone"
                  :disabled="sending" />
                <span class="md-error" v-if="!$v.formUser.telephone.numeric">Invalid Telephone, The Field Most Be a
                  Numeric</span>
                <span class="md-error" v-else-if="!$v.formUser.telephone.minlength">Invalid Telephone, The Field Must
                  Contain More Than 8
                  Characters</span>
              </md-field>
              ...
              <md-field :class="getValidationClass('info')">
                ...
                <md-textarea name="info" id="info" autocomplete="given-name" v-model="formUser.info" md-autogrow
                  :disabled="sending"></md-textarea>
                <span class="md-error" v-if="!$v.formUser.info.minlength">Invalid Info, The Field Must Contain More Than
                  3
                  Characters</span>
              </md-field>
              ...
              <md-field :class="getValidationClass('userType')">
                ...
                <multiselect v-model="formUser.userType" :options="userType" :close-on-select="true"
                  :clear-on-select="false" :preserve-search="true" placeholder="Select one user type" track-by="name"
                  label="name">
                  <span slot="noResult">Oops! No elements found. Consider changing the search
                    query.</span>
                </multiselect>
                <span class="md-error" v-if="!$v.formUser.info.minlength">Invalid User Type, The Field is
                  required</span>
              </md-field>
                  ...
                  <form>
                    <md-card-content>
                      <md-field>
                        ...
                        <multiselect v-model="formPlatformObject.platform" :options="platformList"
                          placeholder="Select one platform" track-by="name" label="name">
                      ...
                      <md-field>
                        ...
                        <multiselect v-model="formPlatformObject.userProfileValue" :options="userProfileList"
                          placeholder="Select one profile" track-by="id" label="name">
                          <span slot="noResult">Oops! No elements found. Consider changing the
                            search query.</span>
                        </multiselect>
                      </md-field>
                    ...
                    <md-button @click="savePlateformObject()" class="md-primary" :disabled="sending">Add Platform
                    </md-button>
                  </form>
                </div>
                <div class="md-layout-item md-size-50">
                  <md-table v-model="platformObjectList">
                    <md-table-row slot="md-table-row" slot-scope="{ item }">
                      ...
                      <md-table-cell md-label="Profile">
                        <md-button class="md-just-icon" @click="deletePlatformObjectitem(item)">
