            ...
            <md-table v-model="userList">
              <md-table-row slot="md-table-row" slot-scope="{ item }">
                ...
                <md-table-cell md-label="State">
                  <md-list v-for="(platform, index) in item.platformList" :key="index" class="md-double-line">
                    <md-list-item>
                      <PlatformObjectUser class="md-list-item-text" :user="item" :platformId="platform.platformId"
                        :token="token"></PlatformObjectUser>
                    </md-list-item>
                  </md-list>
                </md-table-cell>
